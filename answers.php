...
<div class="container">
    <h1 class="quiz-title">Corrections du Quiz</h1>

    <?php if (!$selectedPlayer): ?>
        <p class="quiz-subtitle">Sélectionne un joueur pour voir ses réponses :</p>
    ...
    <?php else: ?>
        ...
        ?>
        <a href="answers.php" class="quiz-btn">⬅️ Retour</a>
    <?php endif; ?>
</div>
